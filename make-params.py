...
params_conbination = pd.DataFrame( list(params_conbination) ,columns=['network', 'interact', 's-max', 'nn', 'k-ave', 'sampling', 'mode'] )
...
# 列入れ替え
col_list = ['id', 'network', 'interact', 's-max', 'nn', 'k-ave', 'sampling', 'mode']
